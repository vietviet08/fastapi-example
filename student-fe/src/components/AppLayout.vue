          ...
          <div class="flex items-center">
            <router-link to="/" class="flex items-center space-x-3 hover:opacity-80 transition-opacity">
              ...
              <div class="hidden sm:block">
                <h1 class="text-xl font-bold text-slate-900">EduManager</h1>
                <p class="text-xs text-slate-500 -mt-1">Student Management System</p>
              </div>
            </router-link>
          </div>
                ...
                >
                  <div v-if="showUserMenu" class="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-lg border border-slate-200 py-2 z-50">
                    <div class="px-4 py-2 border-b border-slate-100">
                      ...
                      <p class="text-xs text-slate-500">Signed in as Administrator</p>
                    </div>
